...
const matchTags = ["Risk Assessment", "Evidence-Based Decisions", "Incident Response", "Strategic Communication", "Data Interpretation"];

const SilentBreachOpportunity = () => {
    ...
    <div className="min-h-screen mesh-bg text-foreground overflow-y-auto">
      <div className="relative z-10 px-8 py-6">
        ...
        <motion.div className="rounded-2xl border border-emerald-400/20 bg-emerald-50/50 px-6 py-4 flex items-center gap-4 mb-8" initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div>
            <p className="text-sm font-semibold text-emerald-600">Silent Breach Track Unlocked!</p>
            <p className="text-xs text-muted-foreground">Based on your Operation Silent Breach performance, you've unlocked this matching internship.</p>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-12 gap-6">
          <motion.div className="col-span-8 bento-card-strong p-8" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
            <div className="flex items-start gap-5 mb-6">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#6C8CFF] to-[#9C6BFF] flex items-center justify-center shadow-[0_0_30px_rgba(108,140,255,0.2)]">
                <Shield className="w-8 h-8 text-white" strokeWidth={1.5} />
              </div>
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <h2 className="text-xl font-bold text-foreground/90">Cybersecurity IR Intern</h2>
                  <span className="px-2.5 py-0.5 rounded-full text-[10px] font-semibold bg-emerald-100 text-emerald-600 border border-emerald-200 uppercase">Silent Breach Track</span>
                </div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-6">
              This internship directly matches the skills you demonstrated in Operation Silent Breach. Work in SecureNet's SOC monitoring alerts, reviewing logs, supporting incident triage, and documenting evidence — exactly what you practiced in the simulation.
            </p>
            ...
            <div className="bento-card p-5 mb-6">
              ...
              <div className="flex gap-3">
                ...
                <button onClick={() => navigate("/quest/silent-breach/internship-plan")} className="flex-1 py-3.5 rounded-2xl border border-primary/30 text-primary font-semibold text-sm flex items-center justify-center gap-2 hover:bg-primary/5 transition-colors">
          ...
          <div className="col-span-4 flex flex-col gap-6">
            <motion.div className="bento-card p-6" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }}>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-foreground/80">Marcus Rivera</h3>
                  <p className="text-xs text-muted-foreground">Sr. IR Analyst, SecureNet</p>
                </div>
              </div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-xs text-muted-foreground">15 students mentored</span>
              </div>
            ...
            <motion.div className="bento-card p-6" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }}>
              ...
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#6C8CFF] to-[#9C6BFF] flex items-center justify-center"><Building2 className="w-5 h-5 text-white" strokeWidth={1.5} /></div>
              ...
              <p className="text-xs text-muted-foreground leading-relaxed mb-3">Leading cybersecurity firm specializing in incident response and threat detection for Fortune 500 companies.</p>
...
export default SilentBreachOpportunity;
